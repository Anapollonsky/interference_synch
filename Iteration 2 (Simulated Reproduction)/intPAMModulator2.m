...
% sir = [0 3 6 12 60]'; 
sir = 100;
snr1 = EbNo1 + 10*log10(slen1); % Signal SNR Calculated
...
h1 = comm.BPSKModulator; % Modulator
h2 = comm.BPSKModulator;
h3 = comm.BPSKDemodulator; %  Demodulator
...
hold all;
for k = 1:length(sir)
    plot(EbNo1, bervec(k, :, 1), 'LineWidth', 2);
end
xlabel('E_b/N_o');
ylabel('SER');
grid on;
